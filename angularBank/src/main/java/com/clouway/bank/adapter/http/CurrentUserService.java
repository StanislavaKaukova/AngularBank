 ...
 */
@Singleton
public class CurrentUserService extends HttpServlet {
  private final SessionIdFinder sessionIdFinder;
  private final SessionRepository sessionRepository;

  @Inject
  public CurrentUserService(SessionIdFinder sessionIdFinder, SessionRepository sessionRepository) {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    resp.getWriter().print(new Gson().toJson("Can not return current account"));
  }
}
